...
//
//  Created by Kamil Bloch on 23/11/2019.
...
class ViewController: UICollectionViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate, MCSessionDelegate, MCBrowserViewControllerDelegate {
    ...
    var peerID = MCPeerID(displayName: UIDevice.current.systemName)
    ...
    func startHosting(action: UIAlertAction) {
        ...
        mcAdvertiserAssistant = MCAdvertiserAssistant(serviceType: "hws-app", discoveryInfo: nil, session: mcSession)
    ...
    func joinSession(action: UIAlertAction) {
        ...
        let mcBrowser = MCBrowserViewController(serviceType: "hws-app", session: mcSession)
