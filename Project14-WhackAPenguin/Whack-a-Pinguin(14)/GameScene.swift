...
//  Whack-a-Pinguin(14)
//
//  Created by Kamil Bloch on 04/06/2019.
...
class GameScene: SKScene {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for node in tappedNodes {
            ...
            if node.name == "charFriend" {
                // they shouldn'nt whack him
                score -= 5
                run(SKAction.playSoundFileNamed("whackBad.caf", waitForCompletion: false))
                whackSlot.showEffect(file: "Fire.sks")
                ...
                whackSlot.showEffect(file: "Magic.sks")
    ...
    func createEnemy() {
        ...
        if numRounds >= 30 {
            ...
            finalScore.position = CGPoint(x: 512, y: 420)
    ...
    func sayGameOver() {
        if let validPath = Bundle.main.path(forResource: "gameOver.caf", ofType: nil) {
